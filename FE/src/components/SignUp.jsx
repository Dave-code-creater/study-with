...
const SignUp = () => {
	...
	const [lastNameForcus, setLastNameForcus] = useState(false);
	...
	const [validateAgreed, setValidateAgreed] = useState(false);
	const [agreedForcus, setAgreedForcus] = useState(false);
